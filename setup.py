...
setup(
    ...
    data_files=[
        ...
        (f'share/{package_name}/config/model_base', _glob_files('config/model_base/*')),
        (f'share/{package_name}/config/model_sensors1', _glob_files('config/model_sensors1/*')),
        (f'share/{package_name}/worlds', _glob_files('worlds/*')),
        (f'share/{package_name}/rviz', _glob_files('rviz/*')),
        (f'share/{package_name}/scripts', _glob_files('scripts/*')),
    ],
