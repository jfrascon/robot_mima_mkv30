...
def generate_launch_description() -> LaunchDescription:
    """
    Build the launch description for the base MiMA MKV30 model.
    """
...
def _include_bridge() -> IncludeLaunchDescription:
    """
    Include the Gazebo bridge launch file for the base model.
    """
    return IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            # Bridge does not use remappings. Topics are defined in a 'config_file'.
...
def _include_rsp() -> IncludeLaunchDescription:
    """
    Include robot_state_publisher for the base model.
    """
    return IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
