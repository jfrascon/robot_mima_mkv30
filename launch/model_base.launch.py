...
def _include_bridge() -> GroupAction:
    """
    Include the Gazebo bridge launch file for the base model in an isolated launch scope.
...
def _include_rsp() -> GroupAction:
    """
    Include robot_state_publisher for the base model in an isolated launch scope.
